...
if there are **warnings** in your commit, these are from the automated linting in the standards package. It is best to clean these up before submitting a PR. The warn against coding style and error for serious offenses.
